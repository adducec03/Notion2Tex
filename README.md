...
notion2tex --config                    # interactive menu -> create/use/edit/delete reusable profiles
notion2tex Export.zip --profile book   # use a specific profile for just this run
```
